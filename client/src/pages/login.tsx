      ...
      <div className="max-w-md w-full bg-white dark:bg-dark-700 rounded-xl shadow-xl overflow-hidden">
        <div className="p-6 md:p-8">
          ...
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-dark-800 dark:text-light-100">Tizimga kirish</h2>
            <p className="text-dark-500 dark:text-light-400 mt-2">
          ...
          <Button 
            variant="outline" 
            className="w-full flex items-center justify-center gap-2 mb-4 py-6 text-lg"
            onClick={handleLogin}
          >
